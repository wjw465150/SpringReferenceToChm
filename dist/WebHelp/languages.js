...
strings["Loading the data for search..."]        ="正在加载搜索数据...";
strings["Type in the word(s) to search for:"]    ="输入单词以搜索目标:";
strings["Search title only"]                     ="仅搜索标题";
strings["Search previous results"]               ="搜索上一次结果";
strings["Display"]                               ="显示";
strings["No topics found!"]                      ="没有找到主题！";

strings["Type in the keyword to find:"]          ="输入要查找的关键字:";

strings["Show all"]                              ="全部显示";
strings["Hide all"]                              ="全部隐藏";
strings["Previous"]                              ="上一个";
strings["Next"]                                  ="下一个";

strings["Loading table of contents..."]          ="正在加载目录表...";
